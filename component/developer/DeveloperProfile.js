        ...
        <div className={styles.profiles}>
            <div className={styles.header}>
                <div className={styles.site}>
                    <div className={classNames(styles.txt_sm, "txt_bold")}>Turing</div>
                </div>
                <div className={styles.icons}>
                    <a onClick={downloadProfile}>
                        <i className={classNames("fas fa-arrow-alt-circle-down", styles.icon_bg)} aria-hidden="true"/>
                    </a>
                    <a onClick={share}>
                        <i className={classNames("fa fa-share-alt", styles.icon_bg)} aria-hidden="true"/>
                    </a>
                </div>
            </div>
            ...
            <div className={styles.job_time}>
                ...
                <div className={classNames(styles.txt_sm, styles.job_full_time)}>{pros.work}</div>
            </div>
            <div className={styles.line}/>
            <div className={styles.skills}>
                <i className={classNames("fas fa-check", styles.icon_bg, styles.icon_cal)}><span
                    className={styles.padding_8}>Skills</span></i>
                <div className={styles.dev_skills}>
                    <div className={classNames(styles.txt_sm, styles.job_full_time)}>This developer went through 4 to 6
                        hours of rigorous vetting in these areas:
                    </div>
                    <div className={styles.skills_vetting}>
                        <div className={classNames(styles.txt_sm, styles.col)}/>
                        <div className={classNames(styles.txt_sm, styles.col)}>Year of experience</div>
                        <div className={classNames(styles.txt_sm, styles.col)}>Vetting results</div>

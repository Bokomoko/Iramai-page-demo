                                    ...
                                    <article>
                                        ...
                                        <ul className={styles.list1}>
                                            <li>
                                                ...
                                                <p className={styles.txt1}>We collect Personal Data that is entered
                                                    on our Service
                                                    or sent to us electronically, for example when you complete a
                                                    web form
                                                    to give Personal Data to us directly (such as contact our
                                                    support), when
                                                ...
                                                <p className={styles.txt1}>When you interact with Turing Enterprises
                                                    ...
                                                    including
                                                    via cookies.</p>
                                                <p className={styles.txt1}>As a user of our Service, our servers
                                                    record
                                                    information (“log data”), including information that your
                                                    computer or
                                                    browser automatically sends whenever you use the Service. This
                                                    log data
                                                    includes your Internet Protocol (“IP”) address (from which we
                                                    understand
                                                    the country you are connecting from at the time you visit the
                                                    Service),
                                                    browser type and settings, the date and time of your
                                                    request.</p>
                                                <p className={styles.txt1}>Where the information that we collect
                                                    automatically on
                                                    our Service is Personal Data, our legal basis for the use of
                                                    this
                                                    information is that it is necessary for the purposes of our
                                                    legitimate
                                                    interests in maintaining the safe operation of our Service as
                                                    well as in
                                                    learning how Service users interact with our Service to improve
                                                    your use
                                                    of it.</p>
                                            </li>
                                            <li>
                                                ...
                                                <ul className={styles.list1_1}>
                                                    <li>
                                                        <span className={styles.icon}></span>
                                                        <div className={styles.txt}>To Provide The Services And
                                                            Respond To
                                                            Requests
                                                        </div>
                                                        <p className={styles.txt1}>Turing Enterprises Inc. uses the
                                                            ...
                                                            Privacy
                                                            Policy. If you provide Personal Data for a certain
                                                            reason, we
                                                            may use the Personal Data in connection with the reason
                                                            for
                                                            which it was provided.</p>
                                                        <p className={styles.txt1}>For instance, if you contact us
                                                            by email, we
                                                            will use the Personal Data you provide to answer your
                                                            question
                                                            or resolve your problem. Also, if you provide Personal
                                                            Data in
                                                            order to obtain access to the Service, we will use your
                                                            Personal
                                                            Data to provide you with access to the Service, maintain
                                                            your
                                                            account, contact you regarding your use of the Service
                                                            or to
                                                            notify you of important changes to the Service, and to
                                                            monitor
                                                            your use of such services. For individuals in the EU,
                                                            such use
                                                            is necessary to respond to or implement your request and
                                                            for the
                                                    ...
                                                    <li>
                                                        ...
                                                        <p className={styles.txt1}>We may use your contact details
                                                            to tell you
                                                            about services we believe will be of interest to you,
                                                            upcoming
                                                            events or other promotions. If we do so, each marketing
                                                            communication we send you will contain instructions
                                                            permitting
                                                            you to "opt out" of receiving future marketing
                                                            communications.
                                                            Note however that as user of our services you cannot opt
                                                            out of
                                                            some administrative communications that are reasonably
                                                            necessary
                                                            to the services, such as service notifications. In
                                                            addition, if
                                                            at any time you wish not to receive any future marketing
                                                            communications or you wish to have your name deleted
                                                            from our
                                                            mailing lists, please contact us as indicated below.</p>
                                                        <p className={styles.txt1}>Where required by applicable law
                                                            (for example,
                                                            if you are an individual in the EU), we will only send
                                                            you
                                                            marketing information by email if you consent to us
                                                            doing so at
                                                            the time you provide us with your Personal Data. When
                                                            you
                                                            provide us with your consent to be contacted for
                                                            marketing
                                                            purposes, you have the right to withdraw your consent at
                                                            any
                                                            time by following the instructions to “opt-out” of
                                                            receiving
                                                            marketing communication in each marketing email we send
                                                            you or
                                                            by contacting us as indicated below.</p>
                                                    </li>
                                                    <li>
                                                        <span className={styles.icon}></span>
                                                        <div className={styles.txt}>As Necessary For Certain
                                                            Legitimate Interests
                                                        </div>
                                                        <p className={styles.txt1}>We use your Personal Data for the
                                                            legitimate
                                                            interests described below:</p>
                                                        <ul className={styles.list1_2}>
                                                            <li>
                                                                <span className={styles.icon}></span>
                                                                <p className={styles.txt1}>To send administrative
                                                                    information to
                                                                    you, for example, information regarding the
                                                                    Service and
                                                                    changes to our terms, conditions, and
                                                                    policies.</p>
                                                            </li>
                                                            <li>
                                                                <span className={styles.icon}></span>
                                                                <p className={styles.txt1}>To respond to your
                                                                    inquiries and
                                                                    fulfill your requests, such as to send you
                                                                    requested
                                                                    materials and newsletters, as well as
                                                                    information and
                                                                    materials regarding our products and
                                                                    services.</p>
                                                            </li>
                                                            <li>
                                                                <span className={styles.icon}></span>
                                                                <p className={styles.txt1}>To conduct analytics on
                                                                    how our Service
                                                                    is being used by you for our internal purposes
                                                                    (namely
                                                                    for providing, maintaining, benchmarking and
                                                                    improving
                                                                    our offerings, identifying usage trends and
                                                                    determining
                                                                    the effectiveness of our promotional campaigns)
                                                                    and to
                                                                    inform our marketing strategy and personalize
                                                                    our
                                                                    communications with you (including providing
                                                                    information
                                                                    on our features and other marketing and
                                                                    service-related
                                                                    announcements relevant to the content and
                                                                    features you
                                                                    engage with).</p>
                                                            </li>
                                                            <li>
                                                                <span className={styles.icon}></span>
                                                                <p className={styles.txt1}>To supplement the
                                                                    information that we
                                                                    collected from you with information obtained
                                                                    from third
                                                                    parties (described above) in order to update,
                                                                    expand and
                                                                    analyze our records, and provide products and
                                                                    services
                                                                    that may be of interest to you.</p>
                                                            </li>
                                                            <li>
                                                                <span className={styles.icon}></span>
                                                                <p className={styles.txt1}>To prevent fraud or
                                                                    criminal activity,
                                                                    misuses of our products or services, and ensure
                                                                    the
                                                            ...
                                                            <li>
                                                                <span className={styles.icon}></span>
                                                                <p className={styles.txt1}>To (a) comply with legal
                                                                    obligations
                                                                    and legal process, (b) respond to requests from
                                                                    public
                                                                    and government authorities including public and
                                                                    government authorities outside your country of
                                                                    residence; (c) enforce our terms and conditions;
                                                                    (d)
                                                                    protect our operations; (e) protect our rights,
                                                                    privacy,
                                                                    safety or property, and/or that of you or
                                                                    others; and
                                                                    (f) allow us to pursue available remedies or
                                                                    limit the
                                                                    damages that we may sustain.</p>
                                                            </li>
                                                            <li>
                                                                <span className={styles.icon}></span>
                                                                <p className={styles.txt1}>If you ask us to delete
                                                                    your data and
                                                                    we are required to fulfil your request, to keep
                                                                    basic
                                                                    data to identify you and prevent further
                                                                    unwanted
                                                                    processing.</p>
                                                            </li>
                                                            <li>
                                                                <span className={styles.icon}></span>
                                                                <p className={styles.txt1}>For individuals in the
                                                                    EU, please see
                                                                    ...
                                                                    this
                                                                    Privacy Policy, you will be informed of such
                                                                    anticipated
                                                                    use prior to or at the time at which the
                                                                    Personal Data
                                                                    is collected and pursuant to the applicable
                                                                    law.</p>
                                                            </li>
                                                        </ul>
                                                    </li>
                                ...
                                <div className="column animated fadeInUp animElem-6">
                                    <article>
                                        ...
                                        <p className={styles.txt1}>When you interact with Turing Enterprises Inc.
                                            ...
                                            with other
                                            information to track, for example, the total number of users of our
                                            Service, the
                                            number of hours worked using our Service, the location of our users, and
                                            how our
                                ...
                                <div className="column animated fadeInUp animElem-6">
                                    <article>
                                        ...
                                        <p className={styles.txt1}>Wherever Turing Enterprises Inc. collects
                                            ...
                                            individual
                                            contributor to a project on the Service, and provide reports containing
                                            such
                                            Personal Data to the designated project managers of the projects within
                                            the
                                            Service upon which you work.</p>
                                        <p className={styles.txt1}>BY VOLUNTARILY PROVIDING US WITH PERSONAL DATA,
                                            YOU ARE
                                ...
                                <div className="column animated fadeInUp animElem-6">
                                    <article>
                                        ...
                                        <p className={styles.txt1}>
                                            ...
                                            <br/>
                                            We may also share your Personal Data with our affiliates and related
                                            companies
                                        ...
                                        <p className={styles.txt1}>
                                            ...
                                            functions
                                            include mailing information, maintaining databases, billing and
                                            processing
                                            payments. When we employ another company to perform a function of this
                                            nature,
                                ...
                                <div className="column animated fadeInUp animElem-6">
                                    <article>
                                        ...
                                        <p className={styles.txt1}>
                                            <strong>Scope</strong>
                                            <br/>
                                            This section applies solely to individuals in the EU (for these
                                            purposes,
                                            reference to the EU also includes the European Economic Area countries
                                            of
                                            ...
                                            is
                                            processed, and what your rights and our obligations are in relation to
                                            such
                                        ...
                                        <div className={styles.txt1}>
                                            ...
                                            <br/>
                                            Subject to applicable EU law, you have the following rights in relation
                                            to your
                                            Personal Data:
                                            <ul className="list-1_2">
                                                <li>
                                                    <span className={styles.icon}></span>
                                                    <p className={styles.txt1}>Right of access. If you ask us, we
                                                        will confirm
                                                        whether we are processing your Personal Data and, if so,
                                                        provide you
                                                        with a copy of that Personal Data along with certain other
                                                        details.
                                                        If you require additional copies, we may need to charge a
                                                        reasonable
                                                        fee.</p>
                                                </li>
                                                <li>
                                                    <span className={styles.icon}></span>
                                                    <p className={styles.txt1}>Right to rectification. If your
                                                        Personal Data is
                                                        inaccurate or incomplete, you are entitled to ask that we
                                                        correct or
                                                        complete it. If we shared your Personal Data with others, we
                                                        will
                                                        tell them about the correction where possible. If you ask
                                                        us, and
                                                        where possible and lawful to do so, we will also tell you
                                                        with whom
                                                        we shared your Personal Data so you can contact them
                                                        directly.</p>
                                                </li>
                                                <li>
                                                    <span className={styles.icon}></span>
                                                    <p className={styles.txt1}>Right to erasure. You may ask us to
                                                        delete or
                                                        remove your Personal Data, such as where you withdraw your
                                                        consent.
                                                        If we shared your data with others, we will tell them about
                                                        the
                                                        erasure where possible. If you ask us, and where possible
                                                        and lawful
                                                ...
                                                <li>
                                                    <span className={styles.icon}></span>
                                                    <p className={styles.txt1}>Right to restrict processing. You may
                                                        ask us to
                                                        restrict or ‘block’ the processing of your Personal Data in
                                                        certain
                                                        circumstances, such as where you contest the accuracy of the
                                                        data or
                                                        object to us processing it. We will tell you before we lift
                                                        any
                                                        restriction on processing. If we shared your Personal Data
                                                        with
                                                        others, we will tell them about the restriction where
                                                        possible. If
                                                ...
                                                <li>
                                                    <span className={styles.icon}></span>
                                                    <p className={styles.txt1}>Right to data portability. You have
                                                        the right to
                                                        obtain your Personal Data from us that you consented to give
                                                        us or
                                                        that was provided to us as necessary in connection with our
                                                        contract
                                                        with you. We will give you your Personal Data in a
                                                        structured,
                                                ...
                                                <li>
                                                    ...
                                                    <p className={styles.txt1}>
                                                        ...
                                                        <ul className="list-1_3">
                                                            <li>
                                                                <p className={styles.txt1}>If we are relying on a
                                                                    legitimate
                                                                    interest to process your Personal Data -- unless
                                                                    we
                                                                    demonstrate compelling </p>
                                                            </li>
                                                            <li>
                                                                <p className={styles.txt1}>If we are processing your
                                                                    Personal Data
                                                ...
                                                <li>
                                                    <span className={styles.icon}></span>
                                                    <p className={styles.txt1}>Rights in relation to automated
                                                        decision-making and
                                                        profiling. You have the right to be free from decisions
                                                        based solely
                                                        on automated processing of your Personal Data, including
                                                        profiling,
                                                        which produce a significant legal effect on you, unless such
                                                        profiling is necessary for entering into, or the performance
                                                        of, a
                                                        contract between you and us, or with your explicit consent.
                                                        We are
                                                        not currently processing your Personal Data for such type of
                                                        automated decision-making, including profiling, but if we
                                                        elect to
                                                        do so in the future we will provide you with notice and
                                                        choice, in
                                                        accordance with EU data protection law.</p>
                                                </li>
                                                <li>
                                                    <span className={styles.icon}></span>
                                                    <p className={styles.txt1}>Right to withdraw consent. If we rely
                                                        on your
                                                        consent to process your Personal Data, you have the right to
                                                        withdraw that consent at any time, but this will not affect
                                                        any
                                                        processing of your data that has already taken place.</p>
                                                </li>
                                                <li>
                                                    <span className={styles.icon}></span>
                                                    <p className={styles.txt1}>Right to lodge a complaint with the
                                                        data protection
                                                        authority. If you have a concern about our privacy
                                                        practices,
                                                        including the way we handled your Personal Data, you can
                                                        report it
                                                        to the data protection authority that is authorized to hear
                                                        those
                                                        concerns.</p>
                                                </li>
                                            </ul>
                                ...
                                <div className="column animated fadeInUp animElem-6">
                                    <article>
                                        ...
                                        <p className={styles.txt1}>
                                            ...
                                            our
                                            organization and delivering the best Services to you. This Privacy
                                            Policy
                                            describes when we process your Personal Data for our legitimate
                                            interests, what
                                            these interests are and your rights. We will not use your Personal Data
                                            for
                                            activities where the impact on you overrides our interests, unless we
                                            have your
                                            consent or those activities are otherwise required or permitted by law.
                                            You have
                                            the right to object to processing that is based on our legitimate
                                            interests. For
                                        ...
                                        <p className={styles.txt1}>
                                            ...
                                            will be
                                            transmitted to servers in the United States as necessary to provide you
                                            with the
                                            services that you requested, administer our contract with you or to
                                            respond to
                                            ...
                                            stringent than or otherwise different from the laws in effect in the
                                            country in
                                            which you are located. Where we transfer your Personal Data out of the
                                            European
                                            Economic Area (EEA) we will take steps to ensure that your Personal Data
                                            receives an adequate level of protection where it is processed and your
                                            rights
                                        ...
                                        <p className={styles.txt1}>
                                            ...
                                            reasonably
                                            necessary to fulfil the purposes for which it was collected and
                                            processed,
                                            including for the purposes of satisfying any legal, regulatory,
                                            accounting or
                                            reporting requirements. If you have elected to receive marketing
                                            communications
                                            from us, we retain information about your marketing preferences until
                                            you opt
                                            out of receiving these communications and in accordance with our
                                            policies.
                                            <br/>
                                            ...
                                            the
                                            purposes for which we use your Personal Data and whether we can achieve
                                            those
                            ...
                            <div className={styles.grid}>
                                <div className="column animated fadeInUp animElem-6">
                                    <article>
                                        ...
                                        <p className={styles.txt1}>You can use the Service without providing any
                                            Personal Data. If
                                            you choose not to provide any Personal Data, you may not be able to use
                                            certain
                                ...
                                <div className="column animated fadeInUp animElem-6">
                                    <article>
                                        ...
                                        <p className={styles.txt1}>Turing Enterprises Inc. does not knowingly
                                            ...
                                            please
                                            do not submit any Personal Data through the Service. We encourage
                                            parents and
                                ...
                                <div className="column animated fadeInUp animElem-6">
                                    <article>
                                        ...
                                        <p className={styles.txt1}>Turing Enterprises Inc. takes reasonable steps to
                                            ...
                                            email or
                                            other electronic transmission is ever fully secure or error free, so you
                                            should
                                            take special care in deciding what information you send to us in this
                                            way.</p>
                                    </article>
                                </div>
                            </div>
                                ...
                                <div className="column animated fadeInUp animElem-6">
                                    <article>
                                        ...
                                        <p className={styles.txt1}>The Service and our business may change from time
                                            ...
                                            you
                                            provide any Personal Data. This Privacy Policy was last updated on the
                                            date

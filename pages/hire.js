                            ...
                            <div className="row">
                                <div className={classNames("col-12")}>
                                    <h2 className={classNames(styles.txt_sm, styles.txt_sm_pm)}>
                                        Build your engineering team with pre-vetted remote developers in just a matter
                                        of days. Find highly-skilled remote engineers who are not only affordable but

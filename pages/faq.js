                            ...
                            <div className={styles.holder}>
                                <div className={styles.grid}>
                                    <div className="column animated fadeInUp animElem-6">
                                        <p className={styles.txt12}>Turing</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className={styles.section}>
                            <div className={styles.holder}>
                                <div className={styles.grid}>
                                    <div className="column animated fadeInUp animElem-6">
                                        <article>
                                            <h2 className={styles.title_1}>What kinds of developers does Turing
                                                hire?</h2>
                                            <p className={styles.txt1}>Turing hires Full Stack, Backend, Data
                                                Engineering,
                        ...
                        <section className={styles.section1}>
                            <div className={styles.holder}>
                                <div className={styles.grid}>
                                    <div className="column animated fadeInUp animElem-6">
                                        <article>
                                            <h2 className={styles.title_1}>Does Turing have positions available for
                                                software
                                                quality assurance specialists?</h2>
                                            <p className={styles.txt1}>Sorry, no. Turing only hires for the roles
                                                mentioned

                ...
                <div className="row">
                  <div className={classNames('col-12')}>
                    <h2 className={classNames(styles.txt_sm, styles.txt_sm_pm)}>
                      ...
                      Turing's Intelligent Talent Cloud. Turing offers Silicon
                ...
                <div className={styles.section}>
                  ...
                  <div className="how-it-works-text how-it-works-text-1">
                    ...
                    <p className={styles.txt_sm}>
                      ...
                      Microsoft, and Stanford, Turing’s intelligent vetting
                ...
                <div className={styles.section}>
                  ...
                  <div className="how-it-works-text how-it-works-text-2">
                    ...
                    <p className={styles.txt_sm}>
                      ...
                      Turing’s Intelligent Talent Cloud matches most companies
                ...
                <div className={styles.section}>
                  ...
                  <div className="how-it-works-text how-it-works-text-3">
                    ...
                    <p className={styles.txt_sm}>
                      ...
                      timezone, Turing has you covered.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.turing_demo_developer}>
                ...
                <div className={styles.turing_demo_developer_profile}>
                  <div className={styles.dev_main}>
                    <img
                      className={styles.dev_profile}
                      src="/assets/developer.png"
                    />
                    <div className={styles.dev_name}>
                      <div className={styles.txt_lg}>Daniel Morales</div>
                      <div
                        className={classNames(styles.txt_sm, styles.job_label)}
                      >
                  ...
                  <div className={styles.dev_recommendation}>
                    <div className={classNames(styles.txt_sm)}>
                      As a full-stack developer, I have 6 years of experience in
                      working on designing distributed systems, building web
                      applications and backend APIs. Contributing to the team's
                      success and grasping new concepts quickly are two of my
                      biggest strengths. I am a critical thinker and a lover of
                      people, who is eager to learn new things in life.
                    </div>
                  </div>
                </div>
